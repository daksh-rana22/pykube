      ...
      <div className="container">
        ...
        <div className="about-mission">
          <div className="about-mission-text">
            ...
            <p className="about-desc">
              Based in Little Elm, Texas, our trainers are active industry professionals — not just instructors — who bring real project experience, hiring insights, and interview expertise directly to your learning journey.
            </p>
